...
Page({
  ...
  data: {
    ...
    producttypes: [
      ...
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype8.png', producttype: '00', text: '沙漏簧', parenttype: '01' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype20.png', producttype: '00', text: '发电机弹性支撑', parenttype: '02' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype21.png', producttype: '00', text: '轨道减震器' , parenttype: '03' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype11.png', producttype: '00', text: '桥梁支座', parenttype: '04' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype12.png', producttype: '00', text: '橡胶支座', parenttype: '04' },
      ...
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype24.png', producttype: '00', text: '叠簧式齿轮箱弹性支撑', parenttype: '02' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype25.png', producttype: '00', text: '轴瓦式齿轮箱弹性支撑', parenttype: '02' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype26.png', producttype: '00', text: '其他风电产品', parenttype: '02' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype27.png', producttype: '00', text: '道岔', parenttype: '03' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype28.png', producttype: '00', text: '安全装置', parenttype: '03' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype29.png', producttype: '00', text: '弹性垫板', parenttype: '03' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype30.png', producttype: '00', text: '套靴', parenttype: '03' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype31.png', producttype: '00', text: '阻尼器', parenttype: '04' },
      { img: 'https://guidaogouwuche.com/wx/storage/fetch/producttype32.png', producttype: '00', text: '止水产品', parenttype: '04' }
    ]
  },
  tapTabsDefault(e) {
